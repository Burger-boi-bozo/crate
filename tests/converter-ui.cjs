...
w.fetch = async (url, options = {}) => {
  ...
  else if (url === '/api/version') data = {version: '4.0.0', build: 'abcdef123456', label: 'v4.0.0 · abcdef123456'};
...
(async () => {
  ...
  assert.equal(doc.querySelector('#build-version').textContent.trim(), 'v4.0.0 · abcdef123456');
